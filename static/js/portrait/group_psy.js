...
var g_psy = new g_psy();
var psy_user = $('#g_useremail').text();
function g_tho_load(){
var psy_url='/group/show_group_result/?task_name='+name+'&module=think'+'&submit_user='+psy_user;
...
function group_draw_content(data){
    ...
    $('#group_weibo_text_1').css('display', 'block');
}
    ...
    require([
        ...
        function(ec){
            ...
            function focus(param) {
                $('#group_weibo_text_1').css('display', 'none');
                $('#group_emotion_loading').css('display', 'block');
                $('#group_weibo_text_1').css('display', 'none');
                //$('#')
                ...
                var ajax_url = '/group/group_sentiment_weibo/?task_name='+name+'&sentiment='+sentiment+'&start_ts='+start_ts+'&submit_user='+psy_user;
...
function Draw_group_trend(data){
    ...
    if(items==null){
        ...
        var html0 = '';
        var url_content = '/group/group_sentiment_weibo/?task_name='+name+'&sentiment=0&start_ts='+times_init+'&submit_user='+psy_user;
        $('#group_weibo_text_1').empty();
                $('#group_emotion_loading').css('display', 'block');
            $('#group_weibo_text_1').css('display', 'none');
