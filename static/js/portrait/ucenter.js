...
var end2_date = new Date();
end2_date.setTime(ss_date.getTime() - 60*60*24*7*1000);
console.log(end2_date);
var s_date = ss_date.format('yyyy-MM-dd');

//console.log(s_date)
var e_date = end2_date.format('yyyy-MM-dd');
//console.log(e_date)
var all_url = '/ucenter/show_user_operation_index/?start_date='+e_date+'&end_date='+s_date;
console.log(all_url)
